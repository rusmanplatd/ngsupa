...
import { CalendarService, formatHour, formatEventTime, startOfDay, isSameDay } from '../calendar.service';
...
@Component({
  ...
  template: `
    ...
    <div class="cal-week-scroll-area" #scrollArea>
      ...
      <div class="cal-week-day-headers">
        ...
        @for (day of calendar.weekDays(); track day.toISOString()) {
          <div
      ...
      <!-- Time grid -->
      <div class="cal-week-time-grid" [style.height.px]="gridHeight">
  ...
  styles: `
    ...
    .cal-week-scroll-area {
      ...
      /* All rows are inside this container so the scrollbar affects all equally,
         keeping columns perfectly aligned. */
    }
...
export class CalendarWeekViewComponent implements OnInit, OnDestroy {
  ...
  private updateCurrentTime(): void {
    ...
    // Show the line only if the current date is visible in the week
    const today = now;
